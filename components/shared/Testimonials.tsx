            ...
            <div className=" text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {testimonials.map((t, i) => (
                        <div
                            key={i}
                            className="bg-white rounded-2xl shadow-md p-6 text-left flex flex-col items-center hover:shadow-lg hover:-translate-y-2 transform transition duration-300"
                        >
                            <img
                                src={t.image}
                                alt={t.name}
